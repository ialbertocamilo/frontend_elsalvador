            ...
            <Page>
                ...
                <Card>
                    <CardBody>
                        ...
                        <Card>
                            <CardBody>
                                <Label className={'caption-top '}>Detalle fachada Norte. Sombra en ventanas</Label>
                                <CustomEditor placeholder='Detalle fachada Norte. Sombra en ventanas'/>
                            </CardBody>
                        </Card>
                        <Card>
                            <CardBody>
                                <Label className={'caption-top '}>Detalle fachada Este. Sombra en ventanas</Label>
                                <CustomEditor placeholder='Detalle fachada Este. Sombra en ventanas'/>
                            </CardBody>
                        </Card>
                        <Card>
                            <Label className={'caption-top '}>Detalle fachada Sur. Sombra en ventanas</Label>
                            <CardBody>
                                <CustomEditor placeholder='Detalle fachada Sur. Sombra en ventanas'/>
                            </CardBody>
                        </Card>
                        <Card>
                            <Label className={'caption-top '}>Detalle fachada Oeste. Sombra en ventanas</Label>
                            <CardBody>
