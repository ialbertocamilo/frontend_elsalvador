					...
					<CardBody>
						<div className='row justify-content-center '>
							<Card
								...
								color='primary'
								onClick={() => router.push(RoutesListWithParams.calculatorProportion(param?.projectId))}>
								Calculo de proporcion muro ventana
							</Card>
							<Card
								style={{ width: '175px', height: '100px ' }}
								color='bg-primary'
								onClick={() => router.push(RoutesListWithParams.calculatorTransmittance(param?.projectId))}
								className='text-center p-2 mx-2 justify-content-center bg-dark-subtle shadow-3d-up-hover pointer-event'>
								Calculo de transmitancia termica de muros
							</Card>
							<Card
								style={{ width: '175px', height: '100px' }}
								onClick={() => router.push(RoutesListWithParams.calculatorWindow(param?.projectId))}
								className='text-center mx-2 justify-content-center bg-dark-subtle shadow-3d-up-hover pointer-event'>
								Calculo de ventanas
							</Card>
							<Card
								style={{ width: '175px', height: '100px' }}
								onClick={() => router.push(RoutesListWithParams.calculatorShading(param?.projectId))}
								className='text-center mx-2 justify-content-center bg-dark-subtle shadow-3d-up-hover pointer-event'>
