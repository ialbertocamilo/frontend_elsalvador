...
const ProportionPage = () => {
    ...
    function div(one: any, two: any) {
        const result = (Number(two) / Number(one)) * 100
        if (result == Infinity) return "0"
        if (isNaN(result)) return "0"
        return result.toFixed(0);
    }

    const [totalGlazed, setTotalGlazed] = useState(0)
    useEffect(() => {
        setProportion((prevValues) => ({
            ...prevValues,
            ['one']: div(opaqueSurface.opaque_surface_1, glazedSurface.glazed_surface_1),
            ['two']: div(opaqueSurface.opaque_surface_2, glazedSurface.glazed_surface_2),
            ['three']: div(opaqueSurface.opaque_surface_3, glazedSurface.glazed_surface_3),
            ['four']: div(opaqueSurface.opaque_surface_4, glazedSurface.glazed_surface_4),
            ['five']: div(opaqueSurface.opaque_surface_5, glazedSurface.glazed_surface_5),
            ['six']: div(opaqueSurface.opaque_surface_6, glazedSurface.glazed_surface_6),
            ['seven']: div(opaqueSurface.opaque_surface_7, glazedSurface.glazed_surface_7),
            ['eight']: div(opaqueSurface.opaque_surface_8, glazedSurface.glazed_surface_8),
            ['nine']: div(opaqueSurface.opaque_surface_9, glazedSurface.glazed_surface_9),
            ['ten']: div(opaqueSurface.opaque_surface_9, glazedSurface.glazed_surface_9),
        }));
        ...
        const glazedTotal = Object.values(glazedSurface).reduce((previousValue, currentValue) => Number(previousValue) + Number(currentValue), 0)
        setTotalGlazed(glazedTotal)
