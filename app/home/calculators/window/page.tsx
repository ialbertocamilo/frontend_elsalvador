...
const WindowPage = () => {
    ...
    function calculateUValue() {
        ...
        formik.setFieldValue('windowUValue',
            (uValue * crystalArea) + (uValue2 * frameArea) + (0.08 * (longVain * 2 + highVain * 2)) / (crystalArea + frameArea))
    }
    ...
    useEffect(() => {
        calculateUValue()
    }, [formik.values.uValue1, formik.values.uValue2, formik.values.longVain, formik.values.highVain, formik.values.frameArea, formik.values.crystalArea])
    ...
    function calculateFrameArea() {
        ...
        formik.setFieldValue('frameArea', (anchoMarco * largoVano * 2) + ((altoVano - anchoMarco * 2) * anchoMarco))
