...
const LocationPage = () => {
    ...
    useEffect(() => {
        if (location?.Place)
            setLocationData(location?.Place?.Label as string)
    }, [location]);
        ...
        <Page>
            ...
            <Card>
                ...
                <CardBody>
                    ...
                    <div className='row'>
                        <div className='col'>
                            <MapLibre location={location} locationInfo={(data: any) => {
                                if (data)
                        ...
                        <div className='col'>
                            ...
                            <Textarea id='location' placeholder='Ubicacion' value={locationData}></Textarea>
                        </div>
                    </div>
                </CardBody>
                <CardFooter>
                    <SaveProjectButton type={ButtonTypes.projectData}
                                       payload={{project_id: '1', payload: locationData, key: key}}></SaveProjectButton>
                    <Button icon={"NavigateNext"} color={"link"} onClick={()=>router.push(RoutesListWithParams.project(params?.projectId))}>Regresar a proyecto</Button>
